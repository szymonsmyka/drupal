<div id="page">
    ...
    <div id="wrapper">
        ...
        <div id="header" class="clearfix container_12">
            ...
            <div class="grid_5">
                ...
                <div id="logo-floater"> 
                    ...
                    <div class="clearfix">
        				<?php if ($site_name): ?>
                        <span id="site-name"><a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a></span><br/>
                        <?php endif; ?>
        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                ...
                <a href="<?php print url('node/1'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/slide-image-3.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption">Pierogi Ruskie - z Rusi a nie z Rosji</div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <div class="slider-item-caption">Flaczki - palce lizać</div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <li class="slider-item">
                <div class="slider-item-image">
                <a href="<?php print url('node/4'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/slide-image-1.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption">Bigos Staropolski - smakuje coraz to lepiej po każdym odgrzaniu</div>
                </li>
                <!-- EOF: slider-item -->
    ...
    <div id="footer-bottom">
        ...
        <div id="footer-bottom-inside" class="clearfix container_12">
            ...
            <div class="grid_12">
        	   <div class="credits-container" style="clear:both; padding-top:12px;">Copyright (c) 2014 Przysmaki Polskie</div>
            </div>
